export const buildServerCgiScript = (): string =>
  [
    ...
    '    echo ">>> strings scan (usage/options)"',
    '    echo "$ strings $RB | grep -Ei \\"usage|help|option| -[a-zA-Z]\\" | head -n 200"',
    '    strings "$RB" 2>/dev/null | grep -Ei "usage|help|option| -[a-zA-Z]" | sed -n "1,200p"',
    '    echo ""',
    '    echo "--------------------------------"',
    '    echo ""',
    '  else',
